# {ORG_SHORT} Module — Infrastructure Impact Assessment
**Module Type:** Context-aware — load for all deployments; execute applicable subsections
**Trigger:** Always loaded; subsections activated based on Step 1 intake (browser-based → 5.4, server-hosted → 5.5, vendor SaaS → 5.6)
...
*{ORG_SHORT} Module — Infrastructure Impact | Parent: Security Impact Report AI Instructions*
